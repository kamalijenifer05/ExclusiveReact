          ...
          <Container>
                      ...
                      {details.color1 && (
                        <Blue
                          style={{
                            ...
                            transform:
                              selectedColors[details.id] === details.color1
                                ? "scale(1.2)"
                                : "scale(.9)",
                            transition:
                          ...
                          onClick={() =>
                            handleColorSelect(details.id, details.color1)
                          }
                        ></Blue>
                      )}
                      ...
                      {details.color2 && (
                        <Red
                          style={{
                            ...
                            transform:
                              selectedColors[details.id] === details.color2
                                ? "scale(1.2)"
                                : "scale(.9)",
                            transition:
                              "transform 0.2s ease, box-shadow 0.2s ease",
                          ...
                          onClick={() =>
                            handleColorSelect(details.id, details.color2)
                          }
                        ></Red>
                      )}
                    </ProductColor>
            ...
            <DeliveryProducts>
              <DeliveryTop>
                <DeliveryImage>
                  <VanImage
                    src={require("../../assets/images/icon-delivery (1).png")}
                  />
                </DeliveryImage>
                <Content>
                  ...
                  <DogFood key={index}>
                    <DogTop>
                      ...
                      <Icons>
                        ...
                        />
                        <LikeImage
                          src={require(`../../assets/images/${product.icons1}`)}
                          alt="image"
                        />
                      </Icons>
                    ...
                    <DogBottom>
                      ...
                      <StarDiv>
                        ...
                        {product.discountedCost ? (
                          <Discount>${product.discountedCost}</Discount>
                        ) : null}
                        ...
                        <ColorDiv>
                          {product.color1 && (
                            <ProductRed
                              ...
                              onClick={() =>
                                handleColorSelect(product.id, product.color1)
                              }
                            ></ProductRed>
                          )}
                          ...
                          {product.color2 && (
                            <Yellow
                              ...
                              onClick={() =>
                                handleColorSelect(product.id, product.color2)
                              }
                            />
                          )}
                        </ColorDiv>
