...
//           <SearchBox>
//           {isSearchVisible && (
//             <SearchInput type='text' value={search} onChange={(input) => setSearch(input.target.value)} placeholder='What are you looking for?' onKeyPress={handleKeyPress}></SearchInput>)}
//             <SearchImage src={require("../../../assets/images/Vector (6).png")} alt='image' SearchIcon onClick={toggleSearch} ></SearchImage>
//           </SearchBox>
//         <Image>
...
//   }
// `;
// // const SearchBoxResponsive = styled(SearchBox)`
