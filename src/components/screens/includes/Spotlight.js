  ...
  return (
    ...
    <SpotContainer>
        <Leftbox>
          <HeaderSection>
            <AppleIcon
              src={require("../../../assets/images/1200px-Apple_gray_logo 1.png")}
              alt="image"
            ></AppleIcon>
      ...
      <Service>
        ...
        <Delivery>
          <DeliveryTop>
            <Image
              src={require("../../../assets/images/Icon-Customer service.png")}
              alt="image"
            />
          </DeliveryTop>
          <DeliveryBottom>
        ...
        <Delivery>
          <DeliveryTop>
            <Image
              src={require("../../../assets/images/Icon-secure.png")}
              alt="image"
            />
          </DeliveryTop>
          <DeliveryBottom>
